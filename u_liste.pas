...
uses
  ...
  Grids, ExtCtrls, Buttons, Spin, StdCtrls,
  u_loaddataset;
...
type
  ...
  Tf_liste = class(TForm)
    ...
    procedure spin_nblignesChange(Sender: TObject);
...
procedure Tf_liste.spin_nblignesChange(Sender: TObject);
begin
   nblignesparpage := spin_nblignes.Value;
end;
